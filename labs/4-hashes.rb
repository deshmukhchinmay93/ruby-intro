...
#puts bitcoin_data
current_value = bitcoin_data["bpi"]["USD"]["rate_float"]
puts "1 Bitcoin is valued at $ #{current_value}"
your_value = current_value * bitcoin
puts "Yout Bitcoin is worth $ #{your_value}"
